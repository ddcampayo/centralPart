...
void linear::fill_matrices(void){ 
  ...
  diag_map   di_d_x, di_d_y;
  diag_map   di_m_x, di_m_y;
...
//      di_m_y[ j ] -= MMji.y();
  ...
  for( diag_map::const_iterator it = di_d_x.begin(); it != di_d_x.end(); ++it ) {
    int i    = it->first;
    FT diagx = it->second;
  ...
  for( diag_map::const_iterator it = di_d_y.begin(); it != di_d_y.end(); ++it ) {
    int i    = it->first;
    FT diagy = it->second;
  ...
  for( diag_map::const_iterator it = di_m_x.begin(); it != di_m_x.end(); ++it ) {
    int i    = it->first;
    FT diagx = it->second;
  ...
  for( diag_map::const_iterator it = di_m_y.begin(); it != di_m_y.end(); ++it ) {
    int i    = it->first;
    FT diagy = it->second;
